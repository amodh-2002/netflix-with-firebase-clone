  ...
  return (
    <div  className='w-[160px] sm:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2'>
        ...
        <div className='absolute top-0 left-0 w-full h-full hover:bg-black/80 hover:opacity-100 opacity-0 text-white'>
            ...
            <p onClick={saveShow}>{like ? <FaHeart className='absolute left-4 top-4 text-gray-300'/> : <FaRegHeart className='absolute left-4 top-4 text-gray-300'/>}</p>
        </div>
    </div>
  )
}
